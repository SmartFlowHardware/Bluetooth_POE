...
#define WICED_DEVICE_NAME                       "L4SEC ENRIBeacon"

uint8_t BT_LOCAL_NAME3[] = { 'L', '4', 'S', 'E', 'C', ' ', 'J', 'J', 'j', ' ', ' ', ' ', ' ', '\0' };
uint8_t BT_LOCAL_NAME2[64];


/*****************************************************************************
 * wiced_bt core stack configuration
 ****************************************************************************/
volatile wiced_bt_cfg_settings_t app_cfg_settings2 =
{
    .device_name                         = (uint8_t *)BT_LOCAL_NAME2,                               /**< Local device name (NULL terminated) */
    ...
    .ble_scan_cfg =                                                 /* BLE scan settings  */
    {
        ...
        .high_duty_scan_window           = 96,//WICED_BT_CFG_DEFAULT_HIGH_DUTY_SCAN_INTERVAL,                /**< High duty scan window */
        ...
        .low_duty_scan_window            = 96,//WICED_BT_CFG_DEFAULT_HIGH_DUTY_SCAN_INTERVAL,                  /**< Low duty scan window */
        ...
        .high_duty_conn_scan_window      = 48,//WICED_BT_CFG_DEFAULT_HIGH_DUTY_CONN_SCAN_WINDOW,            /**< High duty cycle connection scan window */
 ...
 *****************************************************************************/
const wiced_bt_cfg_buf_pool_t app_buf_pools2[WICED_BT_CFG_NUM_BUF_POOLS] =
{
/*  { buf_size, buf_count } */
